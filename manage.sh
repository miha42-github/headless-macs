...
#
# NOTE: This is the orchestrator (renamed from setup.sh in Phase 2).
# The system baseline script (pmset, sysctl, service suppression) is setup.sh.
...
show_cli_usage() {
    cat << EOF
Mac LLM Optimizer — Component Manager
